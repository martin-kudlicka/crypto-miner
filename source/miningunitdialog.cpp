...
MiningUnitDialog::MiningUnitDialog(const MUuidPtr &id, const MinerInterface *minerPlugin, QWidget *parent) : MOptionsDialog(id, parent), _minerPlugin(minerPlugin)
{
  _ui.setupUi(this);
...
MiningUnitDialog::MiningUnitDialog(const MUuidPtr &id, const MinerInterface *minerPlugin, const HwComponent &hwComponent, Coin coin, QWidget *parent) : MOptionsDialog(id, parent), _minerPlugin(minerPlugin)
{
  _ui.setupUi(this);
